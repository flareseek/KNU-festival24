...
export const artistData: ArtistData = {
  apink: {
    ...
    firstSong: [
      ...
      "/src/assets/artist/album/apink_one&six.jpeg",
    ],
    secondSong: [
      "NoNoNo",
      "Secret Garden",
      "https://www.youtube.com/watch?v=hspqQuuuGIw",
      "/src/assets/artist/album/apink_secretgarden.jpeg",
    ],
    thirdSong: [
      "Mr.Chu",
      "Pink Blossom",
      "https://www.youtube.com/watch?v=K5H-GvnNz2Y",
      "/src/assets/artist/album/apink_pinkblossom.jpeg",
    ],
    fourthSong: [
      "LUV",
      "Pink LUV",
      "https://www.youtube.com/watch?v=8dVjSvLzD1I",
      "/src/assets/artist/album/apink_pinkluv.jpeg",
    ],
  },
  roykim: {
    ...
    firstSong: [
      ...
      "/src/assets/artist/album/roy_봄봄봄.jpeg",
    ],
    secondSong: [
      "그때 헤어지면 돼",
      "그때 헤어지면 돼",
      "https://www.youtube.com/watch?v=SkN_hWI6n28",
      "/src/assets/artist/album/roy_그때헤어지면돼.jpeg",
    ],
    thirdSong: [
      "봄이 와도",
      "봄이 와도",
      "https://www.youtube.com/watch?v=moVgOwYOXec",
      "/src/assets/artist/album/roy_봄이와도.jpeg",
    ],
    fourthSong: [
      "잘 지내자, 우리",
      "잘 지내자, 우리(여름날 우리 X 로이킴)",
      "https://www.youtube.com/watch?v=6CkYrki1aFs",
      "/src/assets/artist/album/roy_잘지내자우리.jpeg",
    ],
  },
  glencheck: {
    ...
    firstSong: [
      ...
      "/src/assets/artist/album/glencheck_hautecouture.jpeg",
    ],
    secondSong: [
      "Dazed & Confused",
      "Bleach",
  ...
  creespy: {
    ...
    firstSong: [
      ...
      "/src/assets/artist/album/creespy_bruiseboy.jpeg",
    ],
    secondSong: [
      "Bruiseboy",
      "Bruiseboy",
    ...
    thirdSong: [
      ...
      "/src/assets/artist/album/creespy_daydreaming.jpeg",
    ],
    fourthSong: [
      "Ella",
      "Ella",
      "https://www.youtube.com/watch?v=9hPi2tqL_ik",
      "/src/assets/artist/album/creespy_ella.jpeg",
    ],
  },
  kwoneunbi: {
    ...
    firstSong: [
      ...
      "/src/assets/artist/album/kwoneunbi_lethality.jpeg",
    ],
    secondSong: [
      "여름아 부탁해",
      "여름아 부탁해",
      "https://www.youtube.com/watch?v=Wdpn_mL_l2I",
      "/src/assets/artist/album/kwoneunbi_여름아부탁해.jpeg",
    ],
    thirdSong: [
      "SABOTAGE",
      "SABOTAGE",
      "https://www.youtube.com/watch?v=YguHH5AM4gM",
      "/src/assets/artist/album/kwoneinbi_sabotage.jpeg",
    ],
    fourthSong: [
      "The Flash",
      "The Flash",
      "https://www.youtube.com/watch?v=4dwpcSRX-1s",
      "/src/assets/artist/album/kwoneunbi_theflash.jpeg",
    ],
  },
  choiyuree: {
    ...
    firstSong: [
      ...
      "/src/assets/artist/album/choiyuree_유영.jpeg",
    ],
    secondSong: [
      "밤, 바다",
      "여행 : 플리(playlist) OST Part.2",
      "https://www.youtube.com/watch?v=rKUmYKHu-FI",
      "/src/assets/artist/album/choiyuree_밤바다.jpeg",
    ],
    thirdSong: [
      "잘 지내자, 우리",
      "잘 지내자, 우리",
      "https://www.youtube.com/watch?v=Z2tv0GyQdL8",
      "/src/assets/artist/album/choiyuree_잘지내자우리.jpeg",
    ],
    fourthSong: [
      "그댄 행복에 살텐데",
      "그댄 행복에 살텐데(2022)",
      "https://www.youtube.com/watch?v=mwTnWKAvFyo",
      "/src/assets/artist/album/choiyuree_그댄행복에살텐데.jpeg",
    ],
  },
  gummy: {
    ...
    firstSong: [
      ...
      "/src/assets/artist/album/gummy_기억해줘요내모든날과그때를.jpeg",
    ],
    secondSong: [
      "You Are My Everythig",
      "태양의 후예 OST Part.4 (KBS2 수목드라마)",
      "https://www.youtube.com/watch?v=ToASX6axGuw",
      "/src/assets/artist/album/gummy_youaremyeverythig.jpeg",
    ],
    thirdSong: [
      "친구라도 될 걸 그랬어",
      "Like Them",
      "https://www.youtube.com/watch?v=_Jj3P3bSQpQ",
      "/src/assets/artist/album/gummy_likethem.jpeg",
    ],
    fourthSong: [
      "날 그만 잊어요",
      "Its Different",
      "https://www.youtube.com/watch?v=9tk6j8PUzD4",
      "/src/assets/artist/album/gummy_itsdifferent.jpeg",
    ],
  },
  // 다른 아티스트 추가
};
